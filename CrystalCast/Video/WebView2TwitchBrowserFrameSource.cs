...
public sealed class WebView2TwitchBrowserFrameSource : IVideoFrameSource, INativeVideoFrameSource, IMediaPlaybackTelemetrySource, IMediaPlaybackController
{
    ...
    public string Name => captureMode == WebView2CaptureMode.WindowGraphicsCapture
        ? "Twitch browser (WebView2 window capture)"
        : "Twitch browser (WebView2 JPEG capture)";
