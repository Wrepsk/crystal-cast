...
public sealed class WebView2DailymotionBrowserFrameSource : IVideoFrameSource, IMediaPlaybackTelemetrySource, IMediaPlaybackController
{
    ...
    public WebView2DailymotionBrowserFrameSource(
        string input,
        int width,
        int height,
        float captureFps,
    ...
    public string Name => "Dailymotion browser (WebView2 capture)";
    ...
    private string WritePlayerPage(string contentFolder)
    {
        ...
        File.WriteAllText(playerPagePath, DailymotionPlayerPage.BuildHtml(source, autoplay, loop, audioEnabled, volume));
    ...
    {
        private readonly WebView2DailymotionBrowserFrameSource owner;
        ...
        public BrowserThread(WebView2DailymotionBrowserFrameSource owner)
        {
            this.owner = owner;
            thread = new Thread(ThreadMain)
            {
                IsBackground = true,
                Name = "CrystalCast WebView2 Dailymotion source",
            };
        ...
        private async Task InitializeAsync()
        {
            try
            {
                ...
                owner.browserStatus = "WebView2 loading Dailymotion player";
